...
def lookup_shot_gained(distance, type):
    ...
    if not shots_gained:
        raise ValueError(f'Invalid shot type: {type} and distance: {distance} combination')
...
# print(get_shot_gained(450, "tee", 70, "recovery")) # throws ValueError
